...
SELECT
selected_feed_follow.id, selected_feed_follow.created_at, selected_feed_follow.updated_at, selected_feed_follow.user_id, selected_feed_follow.feed_id,
feeds.name AS feed_name
...
func (q *Queries) RemoveFollow(ctx context.Context, feedID uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, removeFollow, feedID)
	return err
}
